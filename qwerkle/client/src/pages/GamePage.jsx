...
import QwirkleTile from '../components/QwirkleTile';
    ...
    <div className="game-page">
      ...
      <aside className="game-sidebar">
        <div className="sidebar-logo">
          <span className="logo-q">Q</span>wer<span className="logo-k">k</span>le
        </div>
      ...
      >
        ...
        >
          ...
          {staged.map(({ x, y, tile }) => (
            ...
            >
              <QwirkleTile shape={tile.shape} color={tile.color} size={CELL} staged />
            </div>
          ))}
          ...
          {Object.entries(displayBoard).map(([k, tile]) => {
            ...
            return (
              ...
              >
                <QwirkleTile shape={tile.shape} color={tile.color} size={CELL} />
              </div>
            );
          })}
        </div>
